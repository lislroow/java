...
INSERT INTO manager (mgr_id, mgr_name) VALUES('myeonggu.kim@kakao.com', '김매니저');

INSERT INTO openapi_user (user_id, user_name) VALUES('lislroow@daum.net', '김길동');

INSERT INTO token (token_id, user_id, client_ip, use_yn, token) VALUES(
