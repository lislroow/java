package spring.component.config.conditions;
...
import spring.component.config.MapperScannerConfig;

@Slf4j
public class MybatisPostgresEnableCondition implements Condition {
  ...
  public boolean matches(ConditionContext context, AnnotatedTypeMetadata metadata) {
    ...
    String enabled = properties.getProperty("custom.mybatis." + Constant.DBMS.POSTGRES + ".enabled");
