...
import spring.component.common.bean.MybatisMapperNameGenerator;
import spring.component.common.constant.Constant;
import spring.component.common.enumcode.DBMS_TYPE;
import spring.component.config.conditions.MybatisH2EnableCondition;
import spring.component.config.conditions.MybatisMariaEnableCondition;
import spring.component.config.conditions.MybatisOracleEnableCondition;
import spring.component.config.conditions.MybatisPostgresEnableCondition;
import spring.component.config.conditions.MybatisVerticaEnableCondition;
