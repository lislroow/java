...
import spring.sample.Boot23SoapclientMain;
...
import spring.sample.app.repository.QualiSrvcDataRepository;
import spring.sample.app.repository.QualiSrvcRepository;

@DataJpaTest
@ContextConfiguration(classes = {Boot23SoapclientMain.class})
