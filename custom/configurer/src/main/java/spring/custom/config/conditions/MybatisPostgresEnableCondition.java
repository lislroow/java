package spring.custom.config.conditions;
...
import spring.custom.config.MapperScannerConfig;
...
public class MybatisPostgresEnableCondition implements Condition {
  ...
  public boolean matches(ConditionContext context, AnnotatedTypeMetadata metadata) {
    ...
    String enabled = properties.getProperty("custom.mybatis." + Constant.DBMS_TYPE.POSTGRES + ".enabled");
