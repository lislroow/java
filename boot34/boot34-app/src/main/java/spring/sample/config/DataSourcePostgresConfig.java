...
@Configuration
@ConditionalOnProperty(name = "spring.sample.datasource."+Constant.DBMS.POSTGRES+".enabled", havingValue = "true", matchIfMissing = false)
public class DataSourcePostgresConfig {
  
  @Bean(name = Constant.DBMS.POSTGRES + "DataSource")
  @ConfigurationProperties(prefix = "spring.sample.datasource."+Constant.DBMS.POSTGRES+".hikari")
  ...
  @ConditionalOnProperty(name = "spring.sample.datasource." + Constant.DBMS.POSTGRES + ".init", havingValue = "true", matchIfMissing = false)
